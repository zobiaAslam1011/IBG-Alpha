...
Vue.component( 'jet-menu-desktop-menu-items-settings', {
	template: '#jet-dashboard-jet-menu-desktop-menu-items-settings',
	mixins: [ jetMenuSettinsMixin ],
} );

Vue.component( 'jet-menu-desktop-advanced-settings', {
	template: '#jet-dashboard-jet-menu-desktop-advanced-settings',
	mixins: [ jetMenuSettinsMixin ],
} );
