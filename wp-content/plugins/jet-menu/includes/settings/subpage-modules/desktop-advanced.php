...
class Desktop_Advanced extends Page_Module_Base {
	...
	public function get_page_slug() {
		return 'jet-menu-desktop-advanced-settings';
	}
	...
	public function get_page_name() {
		return esc_html__( 'Desktop Advanced', 'jet-menu' );
	}
	...
	public function page_templates( $templates = array(), $page = false, $subpage = false ) {
		...
		$templates['jet-menu-desktop-advanced-settings'] = jet_menu()->plugin_path( 'templates/admin/settings-templates/desktop-advanced-settings.php' );
