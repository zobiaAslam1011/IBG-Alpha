...
class Desktop_Menu_Items extends Page_Module_Base {
	...
	public function get_page_slug() {
		return 'jet-menu-desktop-menu-items-settings';
	}
	...
	public function get_page_name() {
		return esc_html__( 'Desktop Menu Items', 'jet-menu' );
	}
	...
	public function enqueue_module_assets() {
		...
		wp_localize_script(
			...
			apply_filters( 'jet-menu/admin/settings-page-config', jet_menu_option_page()->get_options_page_config() )
		);
	}
	...
	public function page_templates( $templates = array(), $page = false, $subpage = false ) {
		...
		$templates['jet-menu-desktop-menu-items-settings'] = jet_menu()->plugin_path( 'templates/admin/settings-templates/desktop-menu-items-settings.php' );
