<div
	class="jet-menu-settings-page jet-menu-settings-page__desktop-menu-advanced"
>
	<cx-vui-collapse
			...
			foreach ( $levels as $key => $level ) {
				...
				>
					...
					>
						...
						jet_menu_option_page()->render_typography_options( array(
							'name'     => 'jet-menu-' . $level['prefix'] . '-badge',
							'label'    => esc_html__( 'Badge', 'jet-menu' ),
						) );

						jet_menu_option_page()->render_background_options( array(
							'name'  => 'jet-menu-' . $level['prefix'] . '-badge-bg',
							'label' => esc_html__( 'Badge', 'jet-menu' ),
						) );

						jet_menu_option_page()->render_border_options( array(
							'name'     => 'jet-menu-' . $level['prefix'] . '-badge',
							'label'    => esc_html__( 'Badge', 'jet-menu' ),
						) );

						jet_menu_option_page()->render_box_shadow_options( array(
							'name'     => 'jet-menu-' . $level['prefix'] . '-badge',
							'label'    => esc_html__( 'Badge', 'jet-menu' ),
						) );
